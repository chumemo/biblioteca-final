                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group d-flex flex-col justify-content-between mt-4">
                                        <div class="">
                                            ...
                                            <input type="file"  accept=".doc, .docx, .ppt, .pptx, .xls, .xlsx, .pdf"  name="urlDocumento" id="urlDocumento" class="form-control" value="{{ $catalogo->urlDocumento }}">                                            
                                        </div>
                                    </div>

                                    <div class="form-group">
                                    <div class="item">
                                        <input type="hidden" id="temas" name="temas" value="{{ $catalogo->temas }}">
